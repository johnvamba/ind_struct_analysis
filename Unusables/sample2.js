...
$(document).ready(function(){
  ...
  var parts= new Array();
  function partition(){
    var deci=0.05; // a meter divided to parts
    ...
    for (var i=0; i<=len; i+=deci){
      ...
      x = stressesOn(_i);
      // mem = this.findMember(i);
      obj = { 
        _i, // i = a step in beam
        // mem, // mem = member of which step resides // x = stressesOn
        x 
      }
      console.log(_i,x);
      parts.push(obj);
      ...
      $(allData.reactions).each(function(ind, obj){
        ...
        if(allData.memb[ind] !== undefined ){
          ...
          if(c.ltype !== 'noload'){
            ...
            // console.log(c.len,c.load,x,tLength;
